		...
		<form action="<c:url value='/courtPub/vod/caseAndPlan'/>" method="get">
			<div style="width: 1290px; height: 30px;">
				<div class="search_add">
					...
					<input type="hidden" name="trailStatus" value="开庭" /> <input
						type="text" value="输入你要查询的案号……" name="qp_caseNum" id="caseText"
						onfocus="displayText(this.id)" class="text_search" /> <input
						type="hidden" value="${trailStatus}" name="qp_trailStatus"
						id="trailStatus" /> &nbsp;&nbsp; 开始时间:<input type="text"
						id="d242"
				...
				<c:if test="${fn:length(pagi.list) != 0 }">
					<jsp:include page="/common/component/ajaxPager.jsp">
						<jsp:param name="actionUrl"
							value="${pageContext.request.contextPath }/courtPub/vod/pubList" />
