...
<body>
	...
	<div id="add_bill_main" >	
		<div id="head_title" style="width:100%;height: 90px;">
			<span id="add_title"
				style="width: 300px; height: 51px; position: absolute; left: 100px; top: 20px;">更改直播信息</span><br />
			<br /> <br />
			<hr>
		</div>
		<form action="modifyLive" method="post" class="main_form" name="frm"  onsubmit="return validate_channel_info(this);">
					...
					<table id="plan_table">
						<tr>
							...
							<td width="300px"><input type="text" name="courtRoomName"
								...
								<input type="hidden" name="allowLiveFlag" value="${courtCasePlan.allowLiveFlag }" />
								</td>
						...
						<tr>
							...
							<td width="300px"><input type="text" name="heyiName"       
								style="width: 317px;_width:324px;float: left;" value="${collegialName }" id="heyiName" readonly />
						...
						<!-- onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'d241\');}',minDate: '%y-%M-{%d+3}'})" -->
							...
							<td width="260px"><input type="text" id="d242"
								onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'d241\');}'})"
						...
						<tr>
							...
							<td width="260px"><input type="text" id="d241"
								onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'d242\');}'})"
								class="Wdate" style="width: 320px; height: 30px; float: left;"
								name="planEndTimed"
						...
						<tr>
							...
							<td width="260px" align="left" valign="middle" >
								...
								<input type="checkbox" id="push" name="allowLiveFlag" value="2" style="vertical-align:middle;" checked disabled/>
								</c:if>
								<c:if test="${courtCasePlan.allowLiveFlag =='1'}">
								<input type="checkbox" id="push" name="allowLiveFlag" value="2" style="vertical-align:middle;" disabled/>
								</c:if>
						...
						<tr>
							<td align="center" colspan="3"><input type="submit"
								...
								onclick="location.href='<c:url value='/courtPub/vod/pubList'/>';" /></td>
						</tr>
					</table>
				</div>
			</div>
