...
<body style="background-color: #E8F3F8;overflow-y:scroll; font-size: 12px;padding: 10px;">
	<!-- 右侧区域开始 -->
		<form class="pure-form pure-form-aligned" action="<c:url value='/courtPub/vod/byCaseNum'/>" method="get">
			...
			<div class="pure-control-group pure-u-1-6" style="float: left;margin-right: 8px;">
         	 <select id="state"	name="qp_orgId" style="width: 145px;height: 30px;">
	           ...
	           <input id="caseText" type="text" placeholder="输入你要查询的案号……" name="qp_caseNum"  class="bodySearch" style="width: 140px;height: 30px;">
      		</div>
      		 <div class="pure-control-group pure-u-1-8" style="float: left;margin-right: 40px;">
         		 <select id="selectCasetype" class="bodySearch" name="qp_casetype" style="width:140px;height: 30px;">
    		...
    		<div class="pure-1-3" style="float: left;">
	    		&nbsp;开始时间:<input type="text" id="d242" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'d241\');}'})"
								class="Wdate" style="width: 100px; height: 30px;" name="qp_startTime" readonly />
				&nbsp;结束时间：<input type="text" id="d241" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'d242\');}'})"
					class="Wdate" style="width: 100px;height: 30px;" name="qp_endTime" readonly />
    				&nbsp;
    		</div>
